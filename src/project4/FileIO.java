...
/**
 * Contains static helper methods for saving & loading simulation config
 * options or disease parameters
 */
public class FileIO {
    /**
     * Writes the given disease parameters to the specified save file
     * @param diseaseParams List of parameters stored as string
     * @param saveFile File to be saved to
     * @throws IOException If the file does not exist, or is unable to be
     * written to
     */
    ...
    /**
     * Loads in the disease parameters which are found in the specified
     * load file
     * @param loadFile File in which the parameters are stored
     * @return Map object representing the parameters found in the load file
